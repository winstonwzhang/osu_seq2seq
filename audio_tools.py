...
import numpy as np
from wz_os_tools import *
from wz_map_analyze import *
...
def read_osu_file_wz(path,json_name="temp_json_file.json"):
    """
    ...
    # ask load_map.py to convert the .osu file to .json format
